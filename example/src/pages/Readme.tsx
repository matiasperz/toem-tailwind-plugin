...
const proseImg = "prose-img:border prose-img:bg-zinc-900 prose-img:border-white/5 prose-img:rounded-lg prose-img:max-w-[512px]" 
...
const Readme = ({ content }: { content: string }) => {
  return (
    <div className="flex max-w-[1200px] flex-col w-full h-full bg-black border rounded-xl overflow-hidden border-zinc-900">
      ...
      <footer className="flex justify-between mt-auto text-sm border-t border-zinc-900">
        <div className="px-4 py-3">
          Made with{" "}
          <span className="inline-block text-[red] animate-heartbeat">❤️</span>{" "}
          by{" "}
          <a target="_blank" rel="noopener" href="https://matiasperez.dev">
            matiasperz
          </a>
        </div>
