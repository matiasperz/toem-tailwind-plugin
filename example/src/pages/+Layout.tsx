...
const Sidebar = ({ className, mobile = false }: { className?: string, mobile?: boolean }) => {
  ...
  return (
    <div
      className={clsx(
        "sticky bg-black flex flex-col top-0 left-0 h-[calc(100svh-64px)] lg:h-svh min-w-[350px] w-[20vw] border-r border-zinc-900",
        {
          "border-t": mobile
        },
        className
  ...
  return (
    <Popover.Root>
      ...
      <div className="grid min-h-svh w-full grid-cols-1 lg:grid-cols-[max-content_auto]">
        ...
        <div className="flex flex-col items-center justify-center p-4 leading-none lg:p-10 xl:p-16 gridbg gap-y-6">
          {children}
        </div>
      </div>
    </Popover.Root>
