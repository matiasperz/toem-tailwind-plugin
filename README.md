...
![how to use it](https://assets.mtprz.com/toem-tailwind-plugin/how-to-use-it.png?v=6)
...
<div class="text-base flex items-center gap-x-em-[24/16]">
  ...
  <p class="text-em-[13/16]">Lorem Ipsum</p>
  <div></div>
</div>
```
...
![how to use it with single value](https://assets.mtprz.com/toem-tailwind-plugin/how-to-use-it-single-value.png?v=7)
...
<div class="text-base base-em-[16] flex items-center gap-x-em-[24]">
  ...
  <p class="text-em-[13]">Lorem Ipsum</p>
  <div></div>
</div>
```
...
![intellisense](https://assets.mtprz.com/toem-tailwind-plugin/intellisense.png?v=3)
